...
define(<RODATA>, <	.section __TEXT,__picsymbolstub1,symbol_stubs,pure_instructions,32>)
define(<TYPE>, <>)
define(<SIZE>, <>)
define(<LSYM_PREFIX>, <L>)
define(<W32>, <.long>)
define(<ALIGN_LOGARITHMIC>,<yes>)
define(<PIC_ALWAYS>,<yes>)
define(<WANT_R_REGISTERS>,<yes>)
...
include_mpn(`powerpc32/darwin.m4')
